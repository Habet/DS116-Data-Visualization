...
* Create a new variable called liters_per_100km, which is equal to 235.214 divided by mpg
* Group by the cars based on the number of cylinders and summarise the average liters_per_100km for each group
* Filter the cars which consume more than 12 liters per 100 km and arrange them in descending order based on liters_per_100km
